...
{
    public class CategoryType : HeaderData
    {
        ...
        private Boolean Insert(Database db)
        {
            try
            {
                ...
                db.Command.CommandText = "tblCategoryInsert";
        ...
        private Boolean Update(Database db)
        {
            ...
            {
                db.Command.CommandType = CommandType.StoredProcedure;
                db.Command.CommandText = "tblCategoryUpdate";
        ...
        private Boolean Delete(Database db)
        {
            ...
            {
                db.Command.CommandType = CommandType.StoredProcedure;
                db.Command.CommandText = "tblCategoryDelete";
                base.Initialize(db.Command, base.Id);
                db.ExecuteNonQuery();
                base.Initialize(db.Command);
                return true;
        ...
        public CategoryType GetById(Guid Id)
        {
            ...
            {
                db.Command.CommandType = CommandType.StoredProcedure;
                db.Command.CommandText = "tblCategoryGetById";
