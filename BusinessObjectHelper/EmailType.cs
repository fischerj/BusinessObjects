    ...
    public class EmailType : HeaderData
    {
        ...
        private Boolean Insert(Database db)
        {
            try
            {
                ...
                db.Command.CommandText = "tblEmailTypeInsert";
        ...
        private Boolean Update(Database db)
        {
            ...
            {
                db.Command.CommandType = CommandType.StoredProcedure;
                db.Command.CommandText = "tblEmailTypeUpdate";
        ...
        private Boolean Delete(Database db)
        {
            ...
            {
                db.Command.CommandType = CommandType.StoredProcedure;
                db.Command.CommandText = "tblEmailTypeDelete";
                base.Initialize(db.Command, base.Id);
                db.ExecuteNonQuery();
                base.Initialize(db.Command);
                return true;
        ...
        public EmailType GetById(Guid Id)
        {
            ...
            {
                db.Command.CommandType = CommandType.StoredProcedure;
                db.Command.CommandText = "tblEmailTypeGetById";
                ...
                if (dt.Rows.Count == 1)
                {
                    ...
                    throw new Exception("EmailType not found");
            }
            catch (Exception ex)
            {
                throw;
